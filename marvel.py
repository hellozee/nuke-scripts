...
transform1['translate'].setValue([0,0],time=5)
...
transform2['translate'].setValue([0,0],time=5)
transform2.setInput(0,read2)
timeoffset1 = nuke.nodes.TimeOffset()
timeoffset1['time_offset'].setValue(i*5)
...
while i < length:
    ...
    transform['translate'].setValue([0,0],time=5)
    transform.setInput(0,read)
    timeoffset = nuke.nodes.TimeOffset()
    timeoffset['time_offset'].setValue(i*5)
